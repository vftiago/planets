...
// a star's initial size can be random, but it increases with the star's age
// temperature is a function of age
// color is a function of temperature
// stars' ages can vary within a set range, but depend on a galaxy's age (can never be older than the galaxy)
